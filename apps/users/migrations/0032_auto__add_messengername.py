...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MessengerName'
        db.create_table('users_messengername', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('service', self.gf('django.db.models.fields.CharField')(default='AIM', max_length=30)),
        ))
        db.send_create_signal('users', ['MessengerName'])

        # Adding M2M table for field messenger_names on 'UserProfile'
        db.create_table('profile_messenger_names', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['users.userprofile'], null=False)),
            ('messengername', models.ForeignKey(orm['users.messengername'], null=False))
        ))
        db.create_unique('profile_messenger_names', ['userprofile_id', 'messengername_id'])


    def backwards(self, orm):
        
        # Deleting model 'MessengerName'
        db.delete_table('users_messengername')

        # Removing M2M table for field messenger_names on 'UserProfile'
        db.delete_table('profile_messenger_names')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 8, 18, 24, 19, 23890)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 8, 18, 24, 19, 23795)'}),
        ...
        'users.messengername': {
            'Meta': {'object_name': 'MessengerName'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'service': ('django.db.models.fields.CharField', [], {'default': "'AIM'", 'max_length': '30'})
        },
        ...
        'users.userprofile': {
            ...
            'messenger_names': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['users.MessengerName']", 'symmetrical': 'False', 'blank': 'True'}),
