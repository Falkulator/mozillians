...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.privacy_messenger_names'
        db.add_column('profile', 'privacy_messenger_names', self.gf('django.db.models.fields.PositiveIntegerField')(default=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.privacy_messenger_names'
        db.delete_column('profile', 'privacy_messenger_names')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 9, 18, 44, 57, 770425)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 9, 18, 44, 57, 770325)'}),
        ...
        'users.userprofile': {
            ...
            'privacy_messenger_names': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'}),
